...
double calculateRawAngle({required double startAngle, required double angleRange, required double selectedAngle}) {
...
double calculateAngle({required double startAngle, required double angleRange, required selectedAngle, required defaultAngle}) {
  if (selectedAngle == null) {
    return defaultAngle;
  }

  double calcAngle = calculateRawAngle(
      startAngle: startAngle, angleRange: angleRange, selectedAngle: selectedAngle);
...
bool isAngleWithinRange(
  ...
  double calcAngle = calculateRawAngle(
      startAngle: startAngle, angleRange: angleRange, selectedAngle: touchAngle);
